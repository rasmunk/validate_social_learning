...
// Neural Network
extern double gWeightRangeValue;
extern double gDisabledWeightValue;
...
extern bool gScaleSpeed;

// robot dynamics and structure
extern double gMaxTranslationalSpeed; // pixels/sec.
extern double gMaxTranslationalDeltaValue; // default: = gMaxTranslationSpeed (however, may favor bang-bang)
extern double gMaxRotationalSpeed; // degrees/sec.
...
// Robot learning behaviour
extern int gNumberOfTotalEvals;
extern double gEvaluationSeconds;
extern double gRecoverySeconds;

extern int gRobotLifeTime;

extern bool gRobotUseEvolution;
// EA Parameters
extern double gDisabledSensorPercentage;
extern int gTournamentSize;
extern double gMutationRate;
extern int gGenomeStorageCapacity;
extern double gMemomeSharingThreshold;
extern int gMemomeStorageCapacity;
extern bool gRobotUseSocialLearning;

// Robot sigma
extern double gRobotInitialSigma;
extern double gRobotMaxSigma;
extern double gRobotMinSigma;
extern double gRobotSigmaIncrease;
extern double gRobotOldFitnessWeight;

extern double gEvolutionVersion;
...
// Used to track how many pixels a robot should move -> based on how many frames per second are executed
//boost::chrono::time_point gUpdateTime;
