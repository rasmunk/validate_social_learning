...
SocialLearningAgentObserver::SocialLearningAgentObserver( )
{
}

SocialLearningAgentObserver::SocialLearningAgentObserver( RobotWorldModel *__wm )
{
	_wm = __wm;
}
...
void SocialLearningAgentObserver::reset()
{
	// nothing to do.
}

void SocialLearningAgentObserver::step()
{
